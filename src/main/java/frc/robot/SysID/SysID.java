...
public class SysID extends SubsystemBase {
  ...
  private final MutDistance distance = MutableMeasure.mutable(Units.Inches.of(0));
  private final MutAngle angle = MutableMeasure.mutable(Units.Radians.of(0));
  // Mutable holder for unit-safe linear velocity values, persisted to avoid reallocation.
  private final MutLinearVelocity distanceVelocity = MutableMeasure.mutable(Units.InchesPerSecond.of(0));
  private final MutAngularVelocity angularVelocity = MutableMeasure.mutable(Units.RadiansPerSecond.of(0));
  // private final MutAngularVelocity angularVelocity = MutableMeasure.mutable(Units.RPM.of(0));
