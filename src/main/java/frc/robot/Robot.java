...
public class Robot extends TimedRobot {
    ...
    private final CoralSubsystem coral = new CoralSubsystem(coralArm, coralPivot, coralIntake);
    
    private RobotContainer robotContainer = new RobotContainer(drive, coral, elevator);
